        ...
        <div className="hidden md:flex space-x-6">
          {["home", "projects", "about", "contact"].map((section) => (
            <Link
              ...
              smooth={true}
              duration={500}
              className="cursor-pointer text-gray-700 hover:text-[#AEEA94] transition-all text-lg font-medium"
            >
        ...
        <div className="md:hidden flex flex-col items-center bg-[#FAF9F3] py-4 shadow-lg">
          {["home", "projects", "about", "contact"].map((section) => (
            <Link
              ...
              smooth={true}
              duration={500}
              className="cursor-pointer text-gray-700 py-2 hover:text-[#AEEA94] transition-all text-lg font-medium"
